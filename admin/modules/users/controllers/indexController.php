        ...
        if(isset($_POST['btn_register'])) {
            ...
            if(empty($error)){
                if(!user_exists($username,$email)){
                    ...
                    $subject = "Xác thực tài khoảng tại Ismart.vn";
                    ...
                    margin: 10px 0;
                    display: inline-block;'>Click vào đây để kích hoạt tài khoản</a>
                        <p>Mọi thắt mắt xin liên hệ tại địa chỉ email: <span>hoangtien080@gmail.com</span></p>
